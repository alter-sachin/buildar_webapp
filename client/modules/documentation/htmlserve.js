...
<div class="left-menu">
    <div class="content-logo">
        <img alt="AI Videos platform by BuildAR.in that creates videos in 40 Languages" title="platform by Emily van den Heever from the Noun Project" src="../distribution/images/Logo_BuildAR.png" height="64" />
    ...
    <div class="content-menu">
        <ul>
            ...
            <li class="scroll-to-link" action="get-api-access">
                <a href="#get-api-access">Get API Access</a>
            </li>
            <li class="scroll-to-link" data-target="get-available-voices">
                <a href="#overview">Overview</a>
            </li>
            <li class="scroll-to-link" data-target="get-avialable-voices">
                <a href="#get-avialable-voices">Get Available Voices</a>
            </li>
            <li class="scroll-to-link" data-target="generate-audio">
                <a href="#generate-audio">Generate Audio</a>
            </li>
            <li class="scroll-to-link" data-target="generate-video">
...
<div class="content-page">
    ...
    <div class="content">
        <div class="overflow-hidden content-section" id="get-started">
        ...
        <div class="overflow-hidden content-section" id="get-api-access">
        ...
        <div class="overflow-hidden content-section" id="overview">
...
curl -X 'GET' \
  ...
  -H 'Authorization: Bearer YOUR_API_KEY'
            ...
            <p>
                ...
                <code class="higlighted">http://35.232.47.147:8001/audio</code>
            </p>
            <br>
            <pre><code class="json">
Result example :
...
Result example :
{
  ...
  "audioUrl": "string"
         ...
         <div class="overflow-hidden content-section" id="generate-video">
...
curl -X 'POST' \
  ...
  "audioUrl": "URL"
            ...
            <p>
                ...
                <code class="higlighted" style="margin: 4em;">http://35.232.47.147:8001/video</code>
