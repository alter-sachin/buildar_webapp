                  ...
                  <div className="img-wrapper">
                    <div className="w-embed">
                      <video autoPlay playsInline height={930} width={900} loop muted poster="https://www.buildar.in/assets/videos/home.mp4" style={{ height: 'auto', maxWidth: '90%', marginTop: '1.5rem' }}>
                        <source src="https://buildarassets.s3.ap-south-1.amazonaws.com/buildar_sample.mp4" type="video/webm" />
                        <source src="https://buildarassets.s3.ap-south-1.amazonaws.com/buildar_sample.mp4" type="video/mp4" />
