                  ...
                  <div className="row">
                    <div className="col-lg-7 col-xl-6">
                      <div className="text-container">
                        <h2>Create Personalised Videos in Minutes.<br />So You Get That Customer.</h2>
                        <p className="p-large">Now Create Videos Without Ever Hiring Actors Or Film Crew.<br />Type A Script. Choose An AI Model. Your Personal Video Is Ready.</p>
