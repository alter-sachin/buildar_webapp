						...
						<div className="col-md-2">
							<div className="footer-col middle">
								...
								<ul className="list-unstyled li-space-lg p-small">
									...
									<li className="media">
										<i className="fas fa-square" />
										<div className="media-body"><a className="white" href="../../../../documentation/index.html">API</a></div>
									</li>
								</ul>
							</div>
						</div> {/* end of col */}
						...
						<div className="col-md-2">
							<div className="footer-col middle">
								...
								<ul className="list-unstyled li-space-lg p-small">
									...
									<li className="media">
										<i className="fas fa-square" />
										<div className="media-body"><a className="white" href="../../../../documentation/index.html">Developer API</a></div>
									</li>
								</ul>
							</div>
						</div> {/* end of col */}
